...
public class ColorBlobDetector {
	...
	private Imshow showBinaryImage, showHSVImage;
	...
	public ColorBlobDetector() {
		...
		showBinaryImage = new Imshow("Gray Image");
		showHSVImage = new Imshow("HSV Image");
...
/*
		 ...
		 hsvColor.val[0]-mColorRadius.val[0] : 0; double maxH =
		 (hsvColor.val[0]+mColorRadius.val[0] <= 255) ?
		 hsvColor.val[0]+mColorRadius.val[0] : 255;
		 
		  mLowerBound.val[0] = minH; mUpperBound.val[0] = maxH;
		 ...
		 mLowerBound.val[3] = 0; mUpperBound.val[3] = 255;
		  
		  Mat spectrumHsv = new Mat(1, (int)(maxH-minH), CvType.CV_8UC3);
		  
		  for (int j = 0; j < maxH-minH; j++) { byte[] tmp = {(byte)(minH+j),
		  (byte)255, (byte)255}; spectrumHsv.put(0, j, tmp); }
	...
	public void process(Mat rgbaImage) {
		...
		Imgproc.morphologyEx(mMask, mDilatedMask, 3, element);
		/*
		 * Imgproc.erode(mMask, mDilatedMask, element);
		 * Imgproc.dilate(mDilatedMask, mDilatedMask, element);
		 */

		showBinaryImage.showImage(mDilatedMask);
